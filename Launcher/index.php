...
<html>
		<head>
			<meta charset="utf-8">
				<title>Tyrolium Server Site | Launcher</title>
				...
				<div class="d24">
					<div class="a">
						<div class="a1">
							<div class="titre">
								<p class="date"></p>
								<p class="pseudo">Téléchargement</p>
							</div>
							<div class="contenu">
								<p class="Contenu">
									Ci-dessous vous pouvez télécharger le launcher.
								</p>
								<div class="btn">
									<a class="btn" href="http://tyrolium.fr/Contenu/Download/TyroliumLauncher.exe">
										Télécharger (Windows)
									</a>
								</div>
								<div class="btn">
									<a class="btn" href="http://tyrolium.fr/Contenu/Download/TyroliumLauncher.jar">
						...
						<div class="a1">
							<div class="titre">
								<p class="date"></p>
								<p class="pseudo">Comment l'utiliser</p>
							</div>
							<div class="contenu">
								<p class="Contenu">
									Pour savoir comment utiliser le launcher allez sur cette page.
								</p>
								<div class="btn">
									<a class="btn" href="http://tyrolium.fr/ServerMC/Jouer">
										Jouer
									</a>
								</div>
							</div>
						...
						<div class="a1">
							<div class="titre">
								<p class="date"></p>
								<p class="pseudo">Problème</p>
							</div>
							<div class="contenu">
								<p class="Contenu">
									Si vous avez un problème avec notre launcher n'hésitez pas a nous contacter sur les réseaux situés à la droite de ce message.
								</p>
							</div>
						</div>
					</div>
