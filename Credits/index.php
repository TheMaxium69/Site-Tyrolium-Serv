...
<html>
		<head>
			<meta charset="utf-8">
				<title>Tyrolium Server Site | Credit</title>
				...
				<div class="d21">
					<div class="a">
						<div class="a1">
							<div class="titref">
								<p class="date"></p>
								<p class="pseudo">FONDATEURS</p>
							</div>
							<div class="contenu">
								<p class="Contenu">
									<a class="pers" href="http://tyrolium.fr/Employ%C3%A9/Maxime_Tournier">
										TheMaxium69
									</a><br>
								</p>
								<p class="Contenu">
									<a class="pers" href="http://tyrolium.fr/Employ%C3%A9/Pierre-Louis_Devaud">
										Piplex_YT
									</a><br>
								</p>
							</div>
							<div class="titrer">
								<p class="date"></p>
								<p class="pseudo">ADMINISTRATEUR</p>
							</div>
							<div class="contenu">
								<p class="Contenu">
									<a class="pers" href="http://tyrolium.fr/Employ%C3%A9/Norman_Jorge_De_Freitas">
										Rayquacondaytb
									</a><br>
								</p>
							</div>
							<div class="titres">
								<p class="date"></p>
								<p class="pseudo">RESPONSABLES</p>
							</div>
							<div class="contenu">
								<p class="Contenu">
									<a class="pers" href="http://tyrolium.fr/Employ%C3%A9/Florian_Torrao">
										Aizen__Sosuke
									</a><br>
								</p>
							</div>
							<!-- <div class="titrem"> 
								<p class="date"></p>
								<p class="pseudo">MODERATEURS</p>
							</div>
							<div class="contenu">
								<p class="Contenu">
									<a class="pers" href="http://tyrolium.fr/Employ%C3%A9/Dylan_Argentino">
										viking18092003
									</a><br>
								</p>
							</div>-->
